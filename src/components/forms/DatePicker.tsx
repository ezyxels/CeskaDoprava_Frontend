...
export default function DatePicker({
  ...
  return (
    ...
    `}>
        ...
        {/* Datepicker */}
        <ScrollContainer component={"div"} className={`absolute pb-3 px-3 mt-5 rounded-lg bg-gray-50 z-50 w-80 h-fit max-h-[335px] overflow-y-auto shadow-xl flex flex-col
          ${!activated && "hidden"}
