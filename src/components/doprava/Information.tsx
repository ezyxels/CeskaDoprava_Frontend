  ...
  return (
    <div className='bg-body-100'>
      <Wrapper as="section" size="base" paddedContent='base' id="information">
        ...
        <Template as={"div"} className="grid grid-cols-1 md:grid-cols-3 gap-x-5 lg:gap-x-10 gap-y-20 mt-32" animation='slide-up' staggerChildren staggerChildrenIncrement='200' duration='200'>
